...
public class RoomController {
    ...
    public String ceo_room_detail(int room_idx,Model model){
      ...
      return "ceo/ceo_room_detail";
        ...
        //이용자(일반 회원)가 자신이 예약하려고 하는 숙소 정보들 보기 (자신이 짠 여행일정과 장소에 해당하는)
    ...
    //일반회원이 자신이 예약하려고 하는 숙소의 상세 정보 보기
    ...
    //일반회원이 자신이 예약하려고 하는 숙소에 딸린 방 리스트 보기
    ...
    //일반회원이 자신이 예약하려고 하는 숙소에 딸린 방 상세 정보 보기
