...
public class AccommodationController {
    ...
    public String acc_insert(
       ...
       // DS는 전달받은 Data를 request binding시킨다
        ...
        return "redirect:../accommodation/acc_list.do";  //redirect는 이 페이지에 정보는 뿌려주지 않는 것. 그냥 정보는  db에 저장한 뒤 저 페이지로 가는 것. 
    }
    ...
    //메인페이지?에서 모든 등록된 숙소 정보 띄우기
    @RequestMapping(value="acc_all_list.do", produces="application/json;charset=utf-8;")
    @ResponseBody
    public Map<String, Object> acc_all_list(){

        List<AccVo> acclist = accDao.selectAllAccList();
