...
oncomplete: function (data) {
    ...
    function send(f){
        ...
        f.action = "../../accommodation/acc_insert.do";
        f.submit();
    ...
    <form  method="POST" enctype="multipart/form-data">  
        <div id="box" >
            ...
            <tr id="location">
                ...
                <td><input class="uk-input uk-form-width-large"   aria-label="Large"  id="acc_zicode" name="acc_zicode"   style= "border: 1px solid lightgrey; margin-left:53px; "  >
