...
호텔 이름:     [[${acc_name}]]<br/>
방 이름:    [[${info.item_name}]]<br/>
예약날짜:   [[${room_check_in}]]<br/>
상품수량:    [[${info.quantity}]]<br/>
회원이름:    [[${info.partner_user_id}]]<br/>
    ...
    <form  method="POST" enctype="multipart/form-data">  
        <div id="box" >
            ...
            <tr id="location">
                ...
                <td><input class="uk-input uk-form-width-large"   aria-label="Large"  id="acc_addr1" name="acc_location" value="${info.item_name}"  style= "border: 1px solid lightgrey"  ></td>
            </tr>
